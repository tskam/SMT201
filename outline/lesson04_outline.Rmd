...
description: |
  In this lesson, you will learn the basic principles and methods of GIS mapping and Geovisualisation. You will also gain hands-on exercise on using QGIS to perform GIS mapping.
date: "`r Sys.Date()`"
output:
